...
import { 
  Calendar, Clock, Users, DollarSign, Eye, Copy, Check, 
  Instagram, Youtube, Play, ExternalLink, TrendingUp, Zap
} from "lucide-react";
...
export function EventCard({ event, variant = 'default' }: EventCardProps) {
  ...
  const rsvpProgress = event.rsvpGoal ? (event.rsvpCount / event.rsvpGoal) * 100 : 0;
        ...
        <div className="grid grid-cols-3 gap-4 mb-4">
          ...
          {event.totalViews && (
            <div className="text-center p-3 bg-secondary/10 rounded-lg">
              ...
              <div className="text-lg font-bold">{event.totalViews.toLocaleString()}</div>
        ...
        <div className="flex items-center justify-between">
          ...
          {event.isLive && (
            <Button size="sm" variant="secondary" asChild>
              <a href={event.liveLink} target="_blank" rel="noopener noreferrer">
